...
public class PieChart extends ViewGroup {
    ...
    public PieChart(Context context) {
        this(context, null, R.attr.customPieChartStyle);
    }
    ...
    public PieChart(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes( attrs,
                R.styleable.PieChart, defStyle, R.style.PieChartStyle );
     ...
     *                {@link tp.emazurov.lesson1.R.styleable.PieChart} as well as attributes inherited
     *                from {@link android.view.View}.
     */
    public PieChart(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.customPieChartStyle);
    }
